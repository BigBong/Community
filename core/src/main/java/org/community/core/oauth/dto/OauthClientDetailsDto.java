...
import org.community.core.common.GuidGenerator;
...
public class OauthClientDetailsDto implements Serializable {
    ...
    public OauthClientDetailsDto(OauthClientDetails clientDetails) {
        ...
        this.createTime = clientDetails.getCreateTime().toString();
    ...
    public static List<OauthClientDetailsDto> toDtos(List<OauthClientDetails> clientDetailses) {
        ...
        for (OauthClientDetails clientDetail : clientDetailses) {
            dtos.add(new OauthClientDetailsDto(clientDetail));
        }
        return dtos;
    }
